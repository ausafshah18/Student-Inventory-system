package com.ausafdev.student_inventory;

import com.ausafdev.student_inventory.exception.EntityNotFoundException;
import com.ausafdev.student_inventory.exception.ErrorResponse;
...
public class ApplicationExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handledatAccessException(EmptyResultDataAccessException ex)
    {
    ...
    {
        ErrorResponse error = new ErrorResponse(Arrays.asList("Constraint Violation Exception: we cannot process your request with the provided grade."));
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
